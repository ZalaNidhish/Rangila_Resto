...
const Footer = () => {
  return (
    <div className="h-[50vh] w-full bg-slate-300 p-10 flex flex-col gap-5 font-semibold mt-20">
      <div className="flex items-center justify-evenly gap-6"> 
        <div className="logo h-full w-50 flex items-center justify-center">
          <img
            src={logo}
            alt=""
            className="h-50 w-50 object-cover rounded-4xl"
          />
        </div>
